...
class SurveySystem:
    ...
    def ask_question(self, user_id):
        ...
        self.cursor.execute("SELECT COUNT(*) FROM answers WHERE user_id = ?", (user_id,))
        ...
        self.cursor.execute("UPDATE users SET tokens = tokens + ?, last_active = ? WHERE id = ?",
...
if __name__ == "__main__":
    ...
    # Show total policap
    system.cursor.execute("SELECT tokens FROM users WHERE id = ?", (user_id,))
