# adaptive_survey_v4_official.py
...
class AdaptiveSurveyV4:
    ...
    def generate_parliament_link(self, bill_number):
        """Generate official Parliament of Canada link for this bill"""
        if not bill_number:
            return "https://www.parl.ca/legisinfo/"
        
        # Parse bill number (e.g., "C-343" -> "C-343")
        clean_number = bill_number.strip().upper()
        
        # Official Parliament bill document URL format
        return f"https://www.parl.ca/DocumentViewer/en/44-1/bill/{clean_number}/first-reading"
    ...
    def find_relevant_bills(self, user_keywords, limit=5):
        ...
        for row in cur.fetchall():
            ...
            results.append({
                ...
                'parl_link': self.generate_parliament_link(row[1])
            })
    ...
    def start_session(self):
        ...
        for i, bill in enumerate(relevant_bills, 1):
            ...
            if bill['parl_link']:
                print(f"      🔗 Official Text: {bill['parl_link']}")
        ...
        for i, q in enumerate(questions, 1):
            ...
            if q.get('parl_link'):
                print(f"🔗 Read the full bill: {q['parl_link']}")
    ...
    def run_continuous(self):
        ...
        print("🚀 Starting Adaptive Survey V4 with Official Links")
        print("💡 Now with official Parliament of Canada bill texts!")
