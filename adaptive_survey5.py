...
class AdaptiveSurveyV4:
    ...
    def extract_user_keywords(self, user_input):
        ...
        # FIXED: Removed problematic comment from SQL
        cur.execute("""
        ...
        for word in words:
            ...
            elif len(word) > 3 and word not in ['this', 'that', 'with', 'about', 'would', 'want', 'more', 'little']:
                user_keywords.append(word)
    ...
    def run_continuous(self):
        ...
        print("🚀 Starting Adaptive Survey V4")
        print("💡 With Senatair authentication & response tracking")
    ...
    def end_session(self):
        """Properly end the session - FIXED INDENTATION"""
        try:
